...
function SecondContent() {
  ...
  const ApexChart = ({ DtData }) => {
    const colors = [
      '#FF5733', '#33FF57', '#3357FF', '#F39C12', '#D35400',
      '#1ABC9C', '#9B59B6', '#34495E', '#F1C40F', '#E67E22',
      '#2ECC71', '#E74C3C', '#8E44AD', '#3498DB', '#2C3E50',
      '#16A085', '#27AE60', '#C0392B', '#BDC3C7'
    ];
  ...
  return (
    <>
      <div>
        <Flex gap="10px">
          <div>
            <Card className="logoCard"></Card>
            <Card className="chartCard">
            <ApexChart DtData={DtData}/>
            </Card>
          </div>
          <div>
            <Card
